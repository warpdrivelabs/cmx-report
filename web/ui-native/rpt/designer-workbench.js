...
const PERIOD_RAINBOW_COLORS = [
  'var(--sapNegativeElementColor, #e53935)',
  'var(--sapCriticalElementColor, #fb8c00)',
  '#fdd835',
  'var(--sapPositiveElementColor, #43a047)',
  '#00acc1',
  'var(--sapInformationElementColor, #1e88e5)',
  '#8e24aa',
]

const PERIOD_UNKNOWN_COLOR = 'var(--sapInformationElementColor, #64748b)'
